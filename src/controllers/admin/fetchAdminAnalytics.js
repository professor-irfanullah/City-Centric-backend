...
SELECT
    -- GLOBAL OVERVIEW (Grand totals across all Districts/Tehsils)
    SUM(SUM(TOTAL_REPORTS)) OVER() AS GLOBAL_TOTAL_REPORTS,
    SUM(SUM(HUMAN_DEATHS)) OVER() AS GLOBAL_TOTAL_DEATHS,
    SUM(SUM(HUMAN_INJURIES)) OVER() AS GLOBAL_TOTAL_INJURIES,
    SUM(SUM(RESIDENTS)) OVER() AS GLOBAL_TOTAL_RESIDENTS,
    SUM(SUM(SMALL_DEATHS + BIG_DEATHS)) OVER() AS GLOBAL_TOTAL_ANIMALS_DEATH_COUNT,
    SUM(SUM(SMALL_INJURIES + BIG_INJURIES)) OVER() AS GLOBAL_TOTAL_ANIMALS_INJURED_COUNT,
